            ...
            ->schema([
                Group::make()->schema([
                    Section::make('Order Information')->schema([
                        Select::make('user_id')->label('Costumer')->relationship('user', 'name')->searchable()->preload()->required(),
...
Select::make('shipping_methdod')->options([
    'fedex'=>'Fedex',
    'tcs'=>'TCS',
    'lepoad' => 'LEPOARD',
    'm&p' => 'M&P'
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('grand_total')->numeric()->sortable()->money('PKR'),
