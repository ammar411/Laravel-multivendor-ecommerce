            ...
            <div class="mt-5">
              ...
              <form wire:submit.prevent="save">
                 @if (session()->has('error'))
                                <div class="mb-4 bg-red-100 border border-green-200 text-sm text-green-800 rounded-lg p-4 dark:bg-red-800/10 dark:border-green-900 dark:text-green-500" role="alert">
                                    {{ session('error') }}
                                </div>
                            @endif
