  ...
  <div class="container mx-auto px-4">
    ...
    <button 
        ...
        class="border rounded-md py-2 px-4 ml-2">+</button>
                ...
                <td><button  wire:click="removeItem({{ $item['product_id'] }})" class="bg-slate-300 border-2 border-slate-400 rounded-lg px-3 py-1 hover:bg-red-500 hover:text-white hover:border-red-700">  <span wire:loading.remove wire:target="removeItem">Remove</span>
        <span wire:loading wire:target="removeItem">Removing...</span></button></td>
              </tr>
      ...
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="flex justify-between mb-2">
            <span>Subtotal</span>
<span class="font-semibold">{{ Number::currency($this->grand_total, 'PKR') }}</span>
          </div>
          <div class="flex justify-between mb-2">
            <span>Taxes</span>
