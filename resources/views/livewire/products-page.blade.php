          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
            ...
            <ul>
             @foreach ($categories as $catregory)
              <li class="mb-4" wire:key="{{ $catregory->id }}">
                <label for="{{ $catregory->slug }}" class="flex items-center dark:text-gray-400 ">
                  <input type="checkbox" wire:model.live="selected_categories" id="{{ $catregory->slug }}" value="{{ $catregory->id }}" class="w-4 h-4 mr-2">
                  <span class="text-lg">{{ $catregory->name }}</span>
                </label>
              </li>
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              <div class="font-semibold">
                {{ Number::currency($price_range,'PKR') }}
              </div>
              <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="1000000" value="300000" step="1000">
    ...
    <a href="/products/{{ $product->slug }}">
        ...
        @endif
                ...
                <div class="p-3 ">
                  ...
                  <p class="text-lg ">
                    <span class="text-green-600 dark:text-green-600">{{ Number::currency($product->price, 'PKR')}}
</span>
                  </p>
                </div>
